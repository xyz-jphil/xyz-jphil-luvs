...
import static luvml.css.Selector.selector;
import static luvml.css.HtmlTag.*;
import static luvml.css.P.*;
import static luvml.css.V.*;  // Single import for ALL CSS functions and type-safe values!
import static luvml.css.Css.style;
import static luvml.css.SampleCssRulesAdvanced.Styles.*;
